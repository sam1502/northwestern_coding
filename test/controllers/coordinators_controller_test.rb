...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { email: @coordinator.email, name: @coordinator.name, password: @coordinator.password, phoneNumber: @coordinator.phoneNumber } }
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { email: @coordinator.email, name: @coordinator.name, password: @coordinator.password, phoneNumber: @coordinator.phoneNumber } }
